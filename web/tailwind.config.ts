  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Trio categórico das 3 correntes de receita (Visão Geral v3 — mix "De onde vem") — SÓ
        // série categórica, nunca estado (essa semântica é pos/warn/crit acima).
        'cat-serv': 'hsl(var(--cat-serv))',
        'cat-rec': 'hsl(var(--cat-rec))',
        'cat-com': 'hsl(var(--cat-com))',
