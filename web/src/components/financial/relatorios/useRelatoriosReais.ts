 ...
 * (reusa `receita-recorrente`, já ligado noutra tela), Contas em aberto
 * (`relatorios/contas-em-aberto`) e DRE competência (`relatorios/dre`, mês atual + anterior p/ o
 * delta). Regime de caixa do DRE e a geração de PDF/Excel/pacote/histórico saíram da tela — nenhum
 * tinha serviço real no backend (eram só simulação de UI).
 */
